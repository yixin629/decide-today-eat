/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.local.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: b2dbe475822ba9faa2cda3fbf67533e5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "GROQ_API_KEY" | "CHATANYWHERE_API_KEY">> {}
}
