      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-300">写给未来的信，封存此刻的心意</p>
          </div>
          <button
        ...
        {showAddForm && (
          <div className="mb-8 p-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
            <h3 className="text-xl font-bold text-white mb-4">创建新的时光胶囊</h3>
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-white mb-2">写给未来的话 *</label>
                <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-white mb-2">收件人</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-white mb-2">开启日期 *</label>
                <input
                  type="datetime-local"
                ...
                />
                <p className="text-sm text-gray-400 mt-1">在此日期之前，胶囊将保持封存状态</p>
              </div>
                  ...
                  {isLocked ? (
                    <div className="text-center py-8">
                      ...
                      {canOpenNow && (
                        <button
                          ...
                          className="px-6 py-3 bg-gradient-to-r from-yellow-400 to-orange-400 text-white font-bold rounded-lg hover:from-yellow-500 hover:to-orange-500 transition-all transform hover:scale-105"
                        >
                          开启胶囊
                        </button>
                      )}
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">
                        ...
                        <p>开启于：{capsule.opened_at && new Date(capsule.opened_at).toLocaleString('zh-CN')}</p>
                      </div>
                    </div>
                  )}
                </div>
